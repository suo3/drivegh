  ...
  if (!user) {
    return (
      ...
      {/* Hero Section - Not logged in */}
        <section className="relative pt-24 md:pt-32 pb-12 md:pb-24 overflow-hidden bg-gradient-to-br from-primary via-[hsl(217,91%,25%)] to-secondary text-white">
          {/* Animated gradient orbs */}
          <div className="hidden md:block absolute top-20 right-10 w-96 h-96 bg-accent/20 rounded-full blur-3xl animate-float"></div>
          <div className="hidden md:block absolute bottom-20 left-10 w-80 h-80 bg-green-500/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center space-y-3 md:space-y-6 animate-fade-in">
              <div className="inline-block px-3 md:px-4 py-1.5 md:py-2 glass text-white rounded-full text-xs md:text-sm font-semibold mb-2 md:mb-4">
                Billing & Payments
              </div>
